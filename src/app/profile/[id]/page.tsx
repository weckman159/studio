...
export default function ProfilePage({ params }: { params: { id: string } }) {
  ...
  const heroProfile = {
      id: profile.id,
      displayName: profile.displayName || profile.name || 'No Name',
      ...
      badges: ['Легенда клуба', 'Фотограф'], // Mock
      tier: 'gold' as const, // Mock
      stats: { followers: 1200, reputation: 45000, cars: userCars?.length || 0 }, // Mock
      socials: { // Mock
        instagram: '#',
        youtube: '#',
      },
